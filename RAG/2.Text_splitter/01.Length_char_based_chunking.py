...
text_splitter=CharacterTextSplitter(separator=" ",chunk_size=400, chunk_overlap=40)
...
print("chunk 3 -------> ",docs[2])
print("chunk 4 -------> ",docs[3])
print("chunk 5 -------> ",docs[4])
print("chunk 6 -------> ",docs[5])
print("chunk 7 -------> ",docs[6])
print("chunk 8 -------> ",docs[7])